...
%description -l pl
CDK to zestaw widgetÛw zbudowanych na podstawie biblioteki curses.
Zawiera 21 gotowych go uøycia widgetÛw. W∂rÛd nich jest pole
wprowadzania tekstu, lista przewijana, lista wyboru, lista
alfabetyczna, menu rozwijane, lista przyciskÛw, przegl±darka, okienko
dialogowe i wiele innych.

Ta wersja CDK jest prowadzona przez Thomasa Dickeya i nie jest tym
samym, co znajduje siÍ pod adresem http://www.vexus.ca/CDK.html.

%package devel
Summary:	Header files and development documentation for CDK library
Summary(pl):	Pliki nag≥Ûwkowe i dokumentacja do CDK
...
Pliki nag≥Ûwkowe i dokumentacja programisty do biblioteki CDK. Ta
wersja jest prowadzona przez Thomasa Dickeya i nie jest tym samym, co
znajduje siÍ pod adresem http://www.vexus.ca/CDK.html.
...
Thomasa Dickeya i nie jest tym samym, co znajduje siÍ pod adresem
http://www.vexus.ca/CDK.html.
